{
  'variables': {
    ...
    'openssl_sources_linux64-loongarch64': [
      './config/archs/linux64-loongarch64/no-asm/providers/common/der/der_sm2_gen.c',
      './config/archs/linux64-loongarch64/no-asm/providers/common/der/der_digests_gen.c',
      './config/archs/linux64-loongarch64/no-asm/providers/common/der/der_dsa_gen.c',
      './config/archs/linux64-loongarch64/no-asm/providers/common/der/der_ec_gen.c',
      './config/archs/linux64-loongarch64/no-asm/providers/common/der/der_ecx_gen.c',
      './config/archs/linux64-loongarch64/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/linux64-loongarch64/no-asm/providers/common/der/der_wrap_gen.c',
      './config/archs/linux64-loongarch64/no-asm/providers/legacy.ld',
      './config/archs/linux64-loongarch64/no-asm/providers/fips.ld',
  ...
  'sources': ['<@(openssl_sources)', '<@(openssl_sources_linux64-loongarch64)'],
