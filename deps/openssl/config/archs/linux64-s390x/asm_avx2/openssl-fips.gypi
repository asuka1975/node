{
  'variables': {
    ...
    'openssl_sources_linux64-s390x': [
      ...
      './config/archs/linux64-s390x/asm_avx2/providers/common/der/der_sm2_gen.c',
      './config/archs/linux64-s390x/asm_avx2/providers/common/der/der_digests_gen.c',
      './config/archs/linux64-s390x/asm_avx2/providers/common/der/der_dsa_gen.c',
      './config/archs/linux64-s390x/asm_avx2/providers/common/der/der_ec_gen.c',
