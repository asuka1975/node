{
  'variables': {
    ...
    'openssl_sources_linux-ppc64le': [
      './config/archs/linux-ppc64le/no-asm/providers/common/der/der_sm2_gen.c',
      './config/archs/linux-ppc64le/no-asm/providers/common/der/der_digests_gen.c',
      './config/archs/linux-ppc64le/no-asm/providers/common/der/der_dsa_gen.c',
      './config/archs/linux-ppc64le/no-asm/providers/common/der/der_ec_gen.c',
      './config/archs/linux-ppc64le/no-asm/providers/common/der/der_ecx_gen.c',
      './config/archs/linux-ppc64le/no-asm/providers/common/der/der_rsa_gen.c',
      './config/archs/linux-ppc64le/no-asm/providers/common/der/der_wrap_gen.c',
      './config/archs/linux-ppc64le/no-asm/providers/legacy.ld',
      './config/archs/linux-ppc64le/no-asm/providers/fips.ld',
    ...
    'linker_script': '<(PRODUCT_DIR)/../../deps/openssl/config/archs/linux-ppc64le/no-asm/providers/fips.ld'
  },
  'include_dirs': [
    '.',
    './include',
