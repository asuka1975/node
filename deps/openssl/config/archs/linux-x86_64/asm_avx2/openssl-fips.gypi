{
  'variables': {
    ...
    'openssl_sources_linux-x86_64': [
      ...
      './config/archs/linux-x86_64/asm_avx2/crypto/bn/rsaz-avx512.s',
      ...
      './config/archs/linux-x86_64/asm_avx2/providers/common/der/der_sm2_gen.c',
      './config/archs/linux-x86_64/asm_avx2/providers/common/der/der_digests_gen.c',
      './config/archs/linux-x86_64/asm_avx2/providers/common/der/der_dsa_gen.c',
      './config/archs/linux-x86_64/asm_avx2/providers/common/der/der_ec_gen.c',
      './config/archs/linux-x86_64/asm_avx2/providers/common/der/der_ecx_gen.c',
      './config/archs/linux-x86_64/asm_avx2/providers/common/der/der_rsa_gen.c',
      './config/archs/linux-x86_64/asm_avx2/providers/common/der/der_wrap_gen.c',
      './config/archs/linux-x86_64/asm_avx2/providers/legacy.ld',
      './config/archs/linux-x86_64/asm_avx2/providers/fips.ld',
    ...
    'linker_script': '<(PRODUCT_DIR)/../../deps/openssl/config/archs/linux-x86_64/asm_avx2/providers/fips.ld'
  },
  'include_dirs': [
    '.',
    './include',
